...
const config = {
  ...
  organizationName: 'paulswartz', // Usually your GitHub org/user name.
  projectName: 'schemas-docusaurus', // Usually your repo name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/paulswartz/schemas-docusaurus/tree/main/',
        },
        blog: false,
        theme: {
